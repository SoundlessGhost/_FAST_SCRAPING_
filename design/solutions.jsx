          ...
          <div className="pl-row" key={s.name}>
            ...
            <div className="pl-barwrap">
              ...
              <div className="pl-bar-track">
                ...
                <span className={`pl-you pl-you--${s.status}`} style={{ left: `${pct(s.you, s.min, s.max)}%` }} />
              </div>
        ...
        {products.map((p) => (
          <article className="prod" key={p.n}>
            <div className="prod-img" style={{ background: p.c }}>
              <svg viewBox="0 0 60 60"><circle cx="30" cy="26" r="14" fill={p.s} /><rect x="14" y="34" width="32" height="12" rx="4" fill={p.s} /></svg>
            </div>
      ...
      <div className="job-list">
        {jobs.map((j) => (
          <div className="job" key={j.t}>
            <div className="job-l">
              <div className="job-co"><span className="co-mark" style={{ background: j.c }}>{j.co2}</span> {j.co}</div>
    ...
    <div className="vis-frame vis-frame--dark">
      ...
      <svg viewBox="0 0 480 280" style={{ display: "block", width: "100%", height: 280 }}>
        ...
        <g stroke="rgba(255,255,255,0.04)" strokeWidth="1">
          <line x1="0" y1="70" x2="480" y2="70" /><line x1="0" y1="140" x2="480" y2="140" /><line x1="0" y1="210" x2="480" y2="210" />
          <line x1="120" y1="0" x2="120" y2="280" /><line x1="240" y1="0" x2="240" y2="280" /><line x1="360" y1="0" x2="360" y2="280" />
        </g>
        ...
        <g stroke="rgba(122,209,154,0.18)" strokeWidth="1" fill="none">
          <line x1="240" y1="140" x2="80" y2="50" /><line x1="240" y1="140" x2="80" y2="230" /><line x1="240" y1="140" x2="400" y2="50" /><line x1="240" y1="140" x2="400" y2="230" />
          <line x1="240" y1="140" x2="60" y2="140" /><line x1="240" y1="140" x2="420" y2="140" />
        </g>
        {[
          ...
          <React.Fragment key={s.name}>
            ...
            {i < stages.length - 1 ? (
              <div className="pipe-arrow">
                <svg viewBox="0 0 60 80"><path d="M 0 40 L 50 40" stroke="var(--accent)" strokeWidth="1.5" strokeDasharray="3 3" /><path d="M 45 35 L 55 40 L 45 45" fill="none" stroke="var(--accent)" strokeWidth="1.5" /></svg>
              </div>
            ) : null}
          </React.Fragment>
        ))}
...
const SOLUTIONS = [
  {
    ...
    pitch: "Track competitor prices in real-time across hundreds of retailers, marketplaces and OEM sites. Catch undercuts within minutes, not days — protect margins, optimize pricing, and react to the market while your competitors are still reading yesterday's report.",
    ...
    cta: { primary: "Discuss pricing intel", secondary: "See pricing", link: "pricing.html" },
  },
  {
    ...
    pitch: "Extract product data from any marketplace at scale to power your e-commerce analytics and competitive research. Amazon, Walmart, eBay, Shopify, plus regional marketplaces — all delivered on a single unified schema.",
    ...
    cta: { primary: "Discuss marketplace data", secondary: "See pricing", link: "pricing.html" },
  },
  {
    id: "job-market",
    num: "03",
    ...
    pitch: "Aggregate job data from 50+ boards worldwide to track hiring trends, salary data, and skill demand across industries and regions. Indeed, LinkedIn Jobs, Glassdoor, Welcome to the Jungle, StepStone, and many more — deduplicated and normalized.",
    ...
    accent: "indigo",
    Visual: JobsVisual,
    cta: { primary: "Discuss job data", secondary: "See pricing", link: "pricing.html" },
  },
  {
    id: "linkedin-data",
    num: "04",
    ...
    pitch: "Professional data with zero account-ban risk. Access LinkedIn profiles, companies, jobs, and posts at scale with our cookieless approach. No cookies = no bans = no waking up to a dead pipeline at 3 a.m.",
  ...
  },
  {
    ...
    pitch: "Custom REST APIs for any data source with real-time access, JSON or XML responses, and comprehensive documentation. We become the API the source site never gave you — designed around your domain model, not theirs.",
    ...
    accent: "emerald",
    Visual: ApiVisual,
    cta: { primary: "Discuss API design", secondary: "See pricing", link: "pricing.html" },
  },
  {
    id: "data-pipelines",
    num: "06",
    ...
    pitch: "Automated data delivery on your schedule — SFTP, S3, or direct database integration with full data validation and schema normalization. You stop thinking about scrapers. You start thinking about insights.",
    ...
    cta: { primary: "Discuss your pipeline", secondary: "See pricing", link: "pricing.html" },
  },
];
...
const SolutionCard = React.forwardRef(function SolutionCard({ sol, isOpen, onToggle }, ref) {
    ...
    >
      ...
      <button className="sc-ribbon" onClick={onToggle} aria-expanded={isOpen}>
        ...
        <div className="sc-rmetric">
          <div className="sc-rmv">{sol.metric.v}{sol.metric.suffix ? <small>{sol.metric.suffix}</small> : null}</div>
      ...
      <div className="sc-spread">
        <div className="sc-spread-inner">
          ...
          <div className="sc-top">
            ...
            <aside className="sc-side">
              ...
              <ul className="sc-side-list">
                {sol.side.items.map((it) => <li key={it}>{it}</li>)}
              </ul>
            </aside>
          </div>
          ...
          {/* Bottom zone: 3 tiles — what you get / format / CTA */}
          <div className="sc-bottom">
            ...
            <div className="sc-tile sc-tile--cta">
              ...
              <div className="sc-cta-row">
                <a href="#contact" className="btn btn-accent">{sol.cta.primary} <span className="arrow">→</span></a>
...
const root = document.getElementById("solutions-stack");
if (root) ReactDOM.createRoot(root).render(<SolutionsAtlas />);
