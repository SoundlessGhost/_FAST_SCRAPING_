...
export default function AboutPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="ah-headline">
            ...
            <aside className="ah-deck">
              <p>
                Fastscraping is a fully managed web scraping service built for data teams, AI
                companies, and enterprises who need{" "}
                <strong>reliable, large-scale data extraction</strong> without the
          ...
          <div className="mission-grid">
            <div className="mission-left">
              ...
              <p className="mission-body">
                We believe every company should have access to the web data they need — without
                building complex infrastructure, managing proxy pools, or fighting anti-bot
                systems. We handle the complexity so you can focus on what matters: turning data
                into insights.
              </p>
              <div className="mission-quote">
                <div className="mq-mark">&quot;</div>
                <p>Your web scraping team on demand.</p>
                <div className="mq-sub">— Our promise to every client since day one</div>
              </div>
            </div>
            ...
            <div className="mission-right">
              ...
              <article className="principle">
                ...
                <div className="p-body">
                  ...
                  <p>
                    Built to scale with you — from a single source today to fifty in a year. No
                    re-architectures.
                  </p>
                </div>
              </article>
              <article className="principle">
                ...
                <div className="p-body">
                  ...
                  <p>
                    Not an afterthought. Not &quot;best effort.&quot; It&apos;s the core
                    competency we built the company around.
                  </p>
                </div>
              </article>
            </div>
      ...
      {/* ===================== TEAM ===================== */}
      <section className="block team-block" id="team" data-screen-label="03 Team">
        <div className="container">
          <div className="section-head">
            ...
            <p>
              ...
              enterprise-grade success. Three people doing the work of a thirty-person team —
              by automating everything we possibly can.
            </p>
          </div>
          ...
          <article className="founder">
            ...
            <div className="founder-body">
              ...
              <div className="founder-title">Enterprise Web Scraping Expert</div>

              <p className="founder-bio">
                Specializing in <strong>enterprise web scraping</strong>, data pipeline
                engineering, and LinkedIn API solutions. Built Fastscraping to solve data
                extraction challenges that other vendors couldn&apos;t handle —
                Cloudflare-defended targets, scaled LinkedIn pipelines, and silent white-label
              ...
              <ul className="founder-list">
                <li>
                  ...
                  <span className="fl-v">Anti-bot bypass · Cloudflare, DataDome, PerimeterX</span>
                </li>
                <li>
                  <span className="fl-k">Built</span>
                  <span className="fl-v">Fastscraping · Scrayz LinkedIn API</span>
                </li>
                <li>
          ...
          <div className="team-row">
            <article className="member">
              ...
              <div className="member-body">
                ...
                <p>
                  Leading technical architecture and infrastructure decisions. Expert in
            ...
            <article className="member">
              ...
              <div className="member-body">
                ...
                <p>
                  Expert in bypassing Cloudflare, DataDome, PerimeterX, and Akamai. Developing
                  cutting-edge stealth browser technology.
                </p>
                <div className="member-tags">
      ...
      <section className="block values-block" data-screen-label="05 Values">
        <div className="container">
          <div className="section-head">
            ...
            <p>
              Four principles that guide every decision — from how we architect a pipeline to
              how we write an invoice.
            </p>
          </div>

          <div className="values-grid">
            <article className="value">
              <div className="v-rule"><span>I</span></div>
              <h3>Reliability first.</h3>
              <p>
                We build infrastructure that runs 24/7. Our clients depend on us for production
                data pipelines — not experiments.
              </p>
              <div className="v-tag">always on</div>
            </article>

            <article className="value">
              <div className="v-rule"><span>II</span></div>
              <h3>Technical excellence.</h3>
              <p>
                We solve problems others can&apos;t. From Cloudflare to DataDome — we bypass
                what blocks others. The hard problems are why clients hire us.
              </p>
              <div className="v-tag">depth over breadth</div>
            </article>

            <article className="value">
              <div className="v-rule"><span>III</span></div>
              <h3>Client success.</h3>
              <p>
                We measure success by our clients&apos; success. Long-term partnerships, not
                one-off projects. Average tenure: 24+ months.
              </p>
              <div className="v-tag">partnerships</div>
            </article>

            <article className="value">
              <div className="v-rule"><span>IV</span></div>
              <h3>Transparency.</h3>
              <p>
                Clear pricing, honest timelines, and direct communication. No surprises. No
      ...
      <section className="block timeline-block" data-screen-label="06 Timeline">
        <div className="container">
          <div className="section-head">
            ...
            <p>
              Three years, five countries, one hundred million records a month. Here&apos;s how
              Fastscraping got here.
            </p>
          </div>
          ...
          <ol className="timeline">
            <li className="tl-item" data-year="2023">
              ...
              <div className="tl-content">
                ...
                <p>
                  Khalid launches Fastscraping with a vision to simplify enterprise data
                  extraction. First project: a scraper that other vendors had given up on.
                </p>
              </div>
            </li>
            <li className="tl-item" data-year="2024">
              ...
              <div className="tl-content">
                ...
                <p>
                  Partnered with <strong>Ficstar</strong> for ticketing data pipelines —
                  StubHub, SeatGeek, and more. Still running, still ours.
                </p>
              </div>
            </li>
            <li className="tl-item" data-year="2024">
            ...
            <li className="tl-item" data-year="2025">
              ...
              <div className="tl-content">
                ...
                <p>
                  Self-serve LinkedIn API product for developers and small teams. Born from
                  three years of solving the LinkedIn problem at enterprise scale.
                </p>
              </div>
            </li>
            <li className="tl-item" data-year="2025">
              ...
              <div className="tl-content">
                ...
                <p>
                  ...
                  ImmoScout24, Homegate, and more. Multi-source, daily refresh, white-label.
                </p>
              </div>
            </li>
            <li className="tl-item tl-current" data-year="2026">
              ...
              <div className="tl-content">
                ...
                <p>
                  Active pipelines across 5+ countries with zero downtime. Still three
                  engineers. Still no junior intern babysitting scrapers at 3 a.m.
                </p>
              </div>
            </li>
          </ol>
      ...
      {/* ===================== TWO BRANDS ===================== */}
      <section className="block brands-block" id="brands" data-screen-label="07 Brands">
        <div className="container">
          <div className="section-head">
            <div>
            ...
            <p>
              Two products serving two different audiences — both powered by the same anti-bot
              and infrastructure stack we&apos;ve been building since 2023.
            </p>
          </div>
          ...
          <div className="brands-grid">
            <article className="brand-card brand-card--fs">
              ...
              <p className="bc-pitch">
                Any platform, any scale, fully managed. We build it, we run it, we hand you the
                data on schedule.
              </p>
              <ul className="bc-list">
                <li><span className="dot"></span> Custom data pipelines</li>
                <li><span className="dot"></span> Anti-bot bypass included</li>
                <li><span className="dot"></span> Dedicated support</li>
                <li><span className="dot"></span> Enterprise SLAs</li>
              </ul>
            ...
            <article className="brand-card brand-card--sz">
              ...
              <p className="bc-pitch">
                No cookies, no account bans, no babysitting. A real REST API that just returns
                the data.
              </p>
              <ul className="bc-list">
                <li><span className="dot"></span> LinkedIn profiles &amp; companies</li>
                <li><span className="dot"></span> Simple REST API</li>
                <li><span className="dot"></span> Pay-as-you-go pricing</li>
                <li><span className="dot"></span> GDPR compliant</li>
              </ul>
              <div className="bc-foot">
        ...
        <div className="container">
          <div className="cta">
            <div>
              ...
              <p>
                Tell us what you need scraped and at what cadence. We&apos;ll send a free
                sample inside 48–72 hours and tell you honestly whether we&apos;re the right
                team for the job.
              </p>
