...
export default function ContactPage() {
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="ch-headline">
            ...
            <aside className="ch-deck">
              <p>
                Tell us what you need scraped — sites, volume, cadence, delivery — and
                we&apos;ll send a <strong>tailored quote within 24 hours</strong>. If it&apos;s
                something we can deliver well, we&apos;ll follow with a free sample inside 48–72
                hours. If we can&apos;t, we&apos;ll tell you that too.
              </p>
      ...
      <section className="block letter-block" id="letter" data-screen-label="02 Letter">
        <div className="container">
          <div className="letter-grid">
            ...
            <aside className="direct-lines">
              <div className="dl-card dl-card--founder">
                <div className="dl-portrait">
                  <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid slice" width="100%" height="100%">
                    <defs>
                      <pattern id="dotsC" x="0" y="0" width="5" height="5" patternUnits="userSpaceOnUse">
                        <circle cx="2.5" cy="2.5" r="0.6" fill="rgba(255,255,255,0.16)" />
                      </pattern>
                      <linearGradient id="bgC" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#0e5d44" />
                        <stop offset="100%" stopColor="#0a3d2d" />
                      </linearGradient>
                    </defs>
                    <rect width="200" height="200" fill="url(#bgC)" />
                    <rect width="200" height="200" fill="url(#dotsC)" />
                    <g transform="translate(100, 120)">
                      <circle cx="0" cy="-40" r="32" fill="#1a4538" />
                      <path d="M -52 60 Q -52 10 0 10 Q 52 10 52 60 L 52 90 L -52 90 Z" fill="#1a4538" />
                    </g>
                    <text x="10" y="20" fontFamily="Geist Mono" fontSize="8" fill="rgba(255,255,255,0.5)" letterSpacing="0.16em">
                      DIRECT LINE · 01
                    </text>
                  </svg>
                </div>
                <div className="dl-founder-body">
                  ...
                  <p>
                    You&apos;ll be talking to me. I personally reply to every first email within
                    24 hours.
                  </p>
                  <a href="mailto:khalid@fastscraping.com" target="_blank" rel="noopener noreferrer" className="dl-mail">
              ...
              <a href="https://wa.me/8801XXXXXXXXX" className="dl-row dl-row--wa">
                ...
                <div className="dl-row-body">
                  ...
                  <div className="dl-row-v">+880 1XXX XXX XXX</div>
                  <div className="dl-row-s">Fastest for quick questions</div>
                </div>
                <span className="dl-row-arr">→</span>
              </a>

              <a href="https://linkedin.com/in/md-khalid-mahmud-shawon" target="_blank" rel="noopener noreferrer" className="dl-row dl-row--li">
                <span className="dl-ic">
                  <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#" className="dl-row dl-row--call">
                ...
                <div className="dl-row-body">
                  ...
                  <div className="dl-row-s">Best for deeper project scoping</div>
                </div>
                <span className="dl-row-arr">→</span>
              </a>

              <a href="https://upwork.com/freelancers/khalidalsaba" target="_blank" rel="noopener noreferrer" className="dl-row dl-row--up">
                <span className="dl-ic">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="dl-row-body">
                  ...
                  <div className="dl-row-s">For platform-mediated engagements</div>
                </div>
                <span className="dl-row-arr">→</span>
              </a>
            </aside>
      ...
      <section className="block include-block" data-screen-label="03 What to include">
        <div className="container">
          <div className="section-head">
            ...
            <p>
              The more specifics you share, the faster (and more accurate) we can be with the
              quote. Don&apos;t worry if you don&apos;t know all of these — we&apos;ll ask the
              rest on the intro call.
            </p>
          </div>
          ...
          <div className="incl-list">
            <article className="incl-item">
              ...
              <div>
                <h3>The websites</h3>
                <p>
                  URLs of the sites or platforms you want data from. The more specific the
                  better — a category page is more useful than just the homepage.
                </p>
              </div>
            </article>
            <article className="incl-item">
              ...
              <div>
                <h3>The fields</h3>
                <p>
                  What data points matter? Price, title, image, stock, reviews, contact info —
                  list what you actually need to act on.
                </p>
              </div>
            </article>
            <article className="incl-item">
              ...
              <div>
                <h3>The volume</h3>
                <p>
                  Rough scale — 1K records a day? 1M? 100M? It dictates infrastructure choices
                  and pricing tier.
                </p>
              </div>
            </article>
            <article className="incl-item">
              ...
              <div>
                <h3>The cadence</h3>
                <p>Real-time, hourly, daily, weekly, monthly? Or just a one-time historical pull?</p>
              </div>
            </article>
            <article className="incl-item">
              ...
              <div>
                <h3>The delivery</h3>
                <p>
                  REST API, webhook, S3, SFTP, direct DB write, plain CSV via email — tell us
                  how you want it landing.
                </p>
              </div>
            </article>
            <article className="incl-item">
              ...
              <div>
                <h3>Anything else</h3>
                <p>
                  Existing vendor and pricing (so we can match/beat), deadline, white-label
                  needs, NDA requirements.
                </p>
              </div>
            </article>
          </div>
        ...
        <div className="container">
          <div className="tz-card">
            <div className="tz-left">
              ...
              <h2 className="display" style={{ marginTop: 18 }}>
                We&apos;re in Dhaka — <em>already working when you wake up.</em>
              </h2>
              <p>
                The team is based in Bangladesh (GMT+6). That overlaps with EU business hours
                every morning and with US East Coast every afternoon. We answer urgent issues
                24/7 — non-urgent ones, inside 24 hours.
              </p>
            </div>
