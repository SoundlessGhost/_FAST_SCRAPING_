            ...
            <aside className="direct-lines">
              <div className="dl-card dl-card--founder">
                ...
                <div className="dl-founder-body">
                  ...
                  <a href="mailto:khalid@fastscraping.com" className="dl-mail">
              ...
              <a href="https://linkedin.com/in/md-khalid-mahmud-shawon" className="dl-row dl-row--li">
                <span className="dl-ic">
                  <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://upwork.com/freelancers/khalidalsaba" className="dl-row dl-row--up">
                <span className="dl-ic">
                  <svg viewBox="0 0 24 24" fill="currentColor">
